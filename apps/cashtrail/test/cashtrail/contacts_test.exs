defmodule Cashtrail.ContactsTest do
  @moduledoc false
  ...
  describe "categories" do
    ...
    test "list_categories/2 works with pagination", %{tenant: tenant} do
      ...
      assert Contacts.list_categories(tenant, page: 2) == %Cashtrail.Paginator.Page{
               entries: categories,
               page_number: 2,
               page_size: 20,
               total_entries: 25,
  ...
  describe "contacts" do
    ...
    test "list_contacts/2 works with pagination", %{tenant: tenant} do
      ...
      assert Contacts.list_contacts(tenant, page: 2) == %Cashtrail.Paginator.Page{
               entries: categories,
               page_number: 2,
               page_size: 20,
               total_entries: 25,
