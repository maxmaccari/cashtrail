defmodule Cashtray.QueryBuilder do
  @moduledoc """
  ...
  ## Examples
    ...
    iex> Cashtray.QueryBuilder.build_filter(Cashtray.Accounts.User, nil, [])
    Cashtray.Accounts.User

    iex> Cashtray.QueryBuilder.build_filter(Cashtray.Accounts.User, %{first_name: "my name"}, [:first_name])
    #Ecto.Query<from u0 in Cashtray.Accounts.User, where: u0.first_name == ^"my name">

    iex> Cashtray.QueryBuilder.build_filter(Cashtray.Accounts.User, %{first_name: ["my", "name"]}, [:first_name])
    #Ecto.Query<from u0 in Cashtray.Accounts.User, where: u0.first_name in ^["my", "name"]>
  """
  ...
  ## Examples
    ...
    iex> Cashtray.QueryBuilder.build_search(Cashtray.Accounts.User, nil, [])
    Cashtray.Accounts.User

    iex> Cashtray.QueryBuilder.build_search(Cashtray.Accounts.User, "my name", [:first_name, :last_name])
    #Ecto.Query<from u0 in Cashtray.Accounts.User, or_where: ilike(u0.first_name, ^"%my name%"), or_where: ilike(u0.last_name, ^"%my name%")>
  """
